function [results] =mcmcbfnsbr1c5(nit,br, n,T,Y,YL,Yw,YwL, X1,B1,B2,index,indexc,Z1,Xw,W1,W1L,WWr, lambda0, rho0,mu0, delta0,betai0,beta10,beta20,gamma0, sigmav0, Time10,sigmaw0,taul0,taur0,taud0,taug0,taui0,sce)
% =========================================================================
   ...
   % Transition to candidate delta11 with probability acceptr
     ...
     if (i>nomit)
         ...
         if sce==1
             ...
             for t=1:T
                 lambdan0=lambda0(1)*(t<=taul0)+0.25*lambda0(1)*(1-(t<=taul0));
                 rhon0=rho0(1)*(t<=taur0)+0.25*rho0(1)*(t>taur0);
                 gamman0=gamma0(1)*(t<=taug0)+0.25*gamma0(1)*(t>taug0);
                 betain0=betai0(1)*(t<=taui0)+0.25*betai0(1)*(1-(t<=taui0));
         ...
         elseif sce==2
             for t=1:T
                 lambdan0=lambda0(1)*(t<=taul0)+0.5*lambda0(1)*(1-(t<=taul0));
                 rhon0=rho0(1)*(t<=taur0)+0.5*rho0(1)*(t>taur0);
                 gamman0=gamma0(1)*(t<=taug0)+0.5*gamma0(1)*(t>taug0);
                 betain0=betai0(1)*(t<=taui0)+0.5*betai0(1)*(1-(t<=taui0));
                 deltan0=delta0(1)*(t<=taud0(1))+delta0(2)*(1-(t<=taud0(1)));
         ...
         elseif sce==3
             ...
             for t=1:T
                 lambdan0=lambda0(1)*(t<=taul0)+0.75*lambda0(1)*(1-(t<=taul0));
                 rhon0=rho0(1)*(t<=taur0)+0.75*rho0(1)*(t>taur0);
                 gamman0=gamma0(1)*(t<=taug0)+0.75*gamma0(1)*(t>taug0);
                 betain0=betai0(1)*(t<=taui0)+0.75*betai0(1)*(1-(t<=taui0));
                 deltan0=delta0(1)*(t<=taud0(1))+delta0(2)*(1-(t<=taud0(1)));
...
results.taur=taurs;
 results.taug=taugs;
results.taud1=taud1s;
results.taud2=taud2s;
