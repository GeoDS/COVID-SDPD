...
X100=data(301:30000,100); % 2019 smoothed inflow index for all cities
...
%initial value for change-points
taul0=38;
taur0=20; 
taud0=[49; 74];
taug0=35;
...
%initial value for other parameters
...
nomit=nit*br;
%Jan 20 is the initial period (period 0), Jan 21st is period 1
sce=6; 
%1 for high international transimission after taud2
%2 for 2019 international flights
%3 for high international transimission plus 2019 flight
%4 high domestic transmissability
%5 2019 move-in inflow
%6 domestic High high


results=mcmcbfnsbr1c3(nit,br, n1,T,Y,YL,Yw,YwL, X1,B1,B2,index,indexc,Z1,Xw,W5,W5L,WW5, lambda0, rho0,mu0, delta0,betai0,beta10,beta20,gamma0, sigmav0, Time10,sigmaw0,taul0,taur0,taud0,taug0,taui0,sce);
